...
from plotter.styles.output import (
    BASE_SIZE,
    GRAPH_SETTINGS,
    AXIS_SETTINGS,
    MARKER_SETTINGS,
...
def apply_output_image_style(fig):
    ...
    colorbar_dict["title"]["text"] = f"<br><br>{marker.colorbar.title.text}"
    marker_dict = (
...
def save_main_scatter_plot(scatter_fig, aspect_ratio):
    """
    main_scatter_fig: figure generated by main_scatter_graph()
...
fig = read_json("../../test_json.json")
wand_image = save_main_scatter_plot(fig, 1.5)
wand_image.save(filename="test_wand_out.png")
