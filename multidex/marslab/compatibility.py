...
MERSPECT_COLOR_MAPPINGS = {**MERSPECT_M20_COLOR_MAPPINGS,
                           **MERSPECT_MSL_COLOR_MAPPINGS}
...
WAVELENGTH_TO_FILTER = {
    "ZCAM": {
        "L": {630: "L0R", 544: "L0G", 480: "L0B",
              800: "L1", 754: "L2", 677: "L3",
              605: "L4", 528: "L5", 442: "L6",
              },
        "R": {631: "R0R", 544: "R0G", 480: "R0B",
              800: "R1", 866: "R2", 910: "R3",
              939: "R4", 978: "R5", 1022: "R6",
              },
    },
    "MCAM": {
        "L": {
            ...
            495: "L0B",  #
            554: "L0G", 640: "L0R", 527: "L1", 445: "L2",
            751: "L3", 676: "L4", 867: "L5", 1012: "L6",
        },
        "R": {
            482: "R0B",  #
            493: "R0B",  # Accepted value of R0B has changed over time
            495: "R0B",  #
            551: "R0G", 638: "R0R", 527: "R1", 447: "R2",  #
            805: "R3", 908: "R4", 937: "R5", 1013: "R6",  #
        },
    },
}
...
def polish_xcam_spectrum(
    ...
    if scale_to not in [None, "None"]:
        if all(
                [spectrum.get(comp) for comp in scale_to]
        ):
    ...
    for real_filter in real_filters_to_use:
        ...
        if real_filter + "_ERR" in spectrum.keys():
            values[real_filter]["err"] = spectrum[
                                             real_filter + "_ERR"] * eye_scale
