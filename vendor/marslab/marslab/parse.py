...
def parse_product_type(fn,ptype="IMAGE"):
    ...
    try:
        return {"ECM":"Original image product (possibly companded)",
                ...
                "RAD":"Rad-corrected (absolute units, 15-bit int assets scale)",
                "RAS":"Rad-corrected (absolute units, 12-big int assets scale)",
                "RAY":"Rad-corrected (absolute units, 15-bit int dynamic scale)",
                "RDM":"Rad-corrected (absolute units, 15-bit int assets scale, masked)",
                "RIE":"Rad corrected for instrument effects only (int DN)",
                "RIF":"Rad-corrected for instrument effects only (float)",
                "RSM":"Rad-corrected (absolute units, 12-big int assets scale, masked)",
                "RAG":"Gamma-corrected radiance (no longer calibrated units, byte)",
                "RZF":"Zenith-scaled radiance (float)",
                "RZD":"Zenith-scaled radiance (15-bit int assets scale)",
                "RZS":"Zenith-scaled raidance (12-bit int assets scale)",
